...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        # URDFの設定
        .robot_description(
            mappings={"robot_description": LaunchConfiguration("loaded_description")}
        )
        # SRDFの設定
        .robot_description_semantic(file_path="config/crane_plus.srdf")
        # キネマティクスの設定
    ...
    # Start the actual move_group node/action server
    # パラメータをMoveItConfigsBuilderを使った渡し方に変更
    ...
    # MoveitConfigsBuilderのparameter指定に書き直す
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
