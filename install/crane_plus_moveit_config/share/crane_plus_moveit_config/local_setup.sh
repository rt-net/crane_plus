...
: ${AMENT_CURRENT_PREFIX:="/home/user/overlay_ws/src/crane_plus/install/crane_plus_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crane_plus_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/crane_plus_moveit_config/environment/path.sh"
